...
DATABASE_URL = "postgresql://postgres:totcode123!@localhost/trader_master"

engine = create_engine(DATABASE_URL)

df = pd.read_sql("SELECT * FROM candle_googl_minute;", engine)
...
MODEL_PATH = "./model/googl_model.pt"
